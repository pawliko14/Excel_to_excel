...
public class Writer {
	...
	//	GetLastRow();
        ...
        String excelFilePath = PATH_TO_FOLDER + "sales_by_year_test.xls";
         

        
        try {
        	System.out.println("take data from reader: ");
        	objects =ExcelReader.Read_from_file("02.2019");
        ...
        try {
            ...
            FileOutputStream outputStream = new FileOutputStream(PATH_TO_FOLDER + "sales_by_year_test.xls");
	...
	public static void GetLastRow() throws EncryptedDocumentException, InvalidFormatException, IOException
	{
    	...
    	List<String> ListOfCellsInRow = new ArrayList<String>();
		 ...
		 String excelFilePath = PATH_TO_FOLDER + "backups\\" + "sales_by_year_test.xls";
